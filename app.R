    ...
    tabItems(
      ...
      tabItem(tabName = "Analysis",
                      ...
                      fluidRow(                         
                          ...
                          div(style="float:left; width:110px;",radioButtons("smoother","Smoothing type",choices = list("MA"="MA","Loess"="loess"),inline=TRUE)),
                          div(style="float:left; width:80px",numericInput("average_num","MA window",value=10,step=1,min=1,max=NA)),
                          div(style="float:left; width:80px",numericInput("span","Loess span",value=0.05,step=0.01,min=0.01,max=1)),
